...
def test_option_schema_marks_forward_ref_evaluation_errors_unavailable(
    ...
    _write_module(
        ...
        class ExplodingOptions:
            value: "1/0" = field(default=1, metadata={"workload_option": WorkloadOptionMetadata(label="Value")})
        ...
        class ExplodingOptionWorkload(BenchmarkWorkload):
            name = "exploding_option"
            label = "Exploding Option"
            description = "Exploding option workload"
            options_type = ExplodingOptions
