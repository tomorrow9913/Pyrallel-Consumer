...
def test_reset_topics_ignores_unknown_topic(monkeypatch: pytest.MonkeyPatch) -> None:
    # Given: inputs for `reset topics ignores unknown topic` are prepared.
    admin = mock.Mock()
    ...
    # When: the Kafka admin reset code path is exercised.
    ...
    # Then: the expected `reset topics ignores unknown topic` behavior is asserted.
...
def test_reset_groups_ignores_missing_group(monkeypatch: pytest.MonkeyPatch) -> None:
    # Given: inputs for `reset groups ignores missing group` are prepared.
    admin = mock.Mock()
    ...
    # Then: the expected `reset groups ignores missing group` behavior is asserted.
...
def test_reset_topics_raises_after_retry(monkeypatch: pytest.MonkeyPatch) -> None:
    # Given: inputs for `reset topics raises after retry` are prepared.
    admin = mock.Mock()
    ...
    # When: the Kafka admin reset code path is exercised.
    # Then: the expected `reset topics raises after retry` behavior is asserted.
