...
- [01-ingress/01-kafka-runtime-ingest](./features/01-ingress/01-kafka-runtime-ingest/00-index.md)
- [01-ingress/02-ordered-work-scheduling](./features/01-ingress/02-ordered-work-scheduling/00-index.md)
...
- [02-reliability/01-offset-commit-state](./features/02-reliability/01-offset-commit-state/00-index.md)
- [02-reliability/02-rebalance-retry-dlq](./features/02-reliability/02-rebalance-retry-dlq/00-index.md)
...
- [03-execution/01-async-execution-engine](./features/03-execution/01-async-execution-engine/00-index.md)
- [03-execution/02-process-execution-engine](./features/03-execution/02-process-execution-engine/00-index.md)
...
- [04-tooling/01-observability-metrics](./features/04-tooling/01-observability-metrics/00-index.md)
- [04-tooling/02-benchmark-runtime](./features/04-tooling/02-benchmark-runtime/00-index.md)
