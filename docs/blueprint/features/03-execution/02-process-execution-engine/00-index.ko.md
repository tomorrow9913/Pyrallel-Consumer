...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](01-requirements.ko.md) | process engine의 책임과 acceptance 기준 |
| [02-architecture.md](02-architecture.ko.md) | worker process, IPC queue, batch accumulator, registry flow |
| [03-design.md](03-design.ko.md) | config key, worker 제약, IPC payload 계약 |
