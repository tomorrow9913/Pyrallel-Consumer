...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](01-requirements.ko.md) | async engine의 책임과 acceptance 기준 |
| [02-architecture.md](02-architecture.ko.md) | semaphore, task lifecycle, completion flow |
| [03-design.md](03-design.ko.md) | config key, worker contract, completion payload 규칙 |
