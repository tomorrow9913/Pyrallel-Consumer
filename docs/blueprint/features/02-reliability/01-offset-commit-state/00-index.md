...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](./01-requirements.md) | commit-safe state machine의 책임과 acceptance 기준 |
| [02-architecture.md](./02-architecture.md) | `OffsetTracker`와 `MetadataEncoder`의 관계와 흐름 |
| [03-design.md](./03-design.md) | canonical 용어, metadata encoding 규칙, 핵심 field 계약 |
