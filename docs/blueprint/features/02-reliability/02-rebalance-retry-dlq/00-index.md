...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](./01-requirements.md) | epoch fencing, retry, DLQ의 책임과 acceptance 기준 |
| [02-architecture.md](./02-architecture.md) | assign/revoke, completion validation, retry-to-DLQ 흐름 |
| [03-design.md](./03-design.md) | config key, DLQ header, failure state 계약 |
