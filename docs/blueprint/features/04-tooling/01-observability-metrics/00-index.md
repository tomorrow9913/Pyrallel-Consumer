...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](./01-requirements.md) | metrics surface의 책임과 acceptance 기준 |
| [02-architecture.md](./02-architecture.md) | `BrokerPoller.get_metrics()`와 exporter projection 관계 |
| [03-design.md](./03-design.md) | metric 이름, label, config key, 운영 해석 규칙 |
