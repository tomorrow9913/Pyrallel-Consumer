...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](01-requirements.ko.md) | ordering-aware scheduling의 책임과 acceptance 기준 |
| [02-architecture.md](02-architecture.ko.md) | queue topology, runnable selection, blocking-first policy |
| [03-design.md](03-design.ko.md) | ordering mode별 계약, `WorkItem` 사용 규칙, queue state shape |
