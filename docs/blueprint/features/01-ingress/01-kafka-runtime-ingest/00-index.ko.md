...
| 문서 | 역할 |
| --- | --- |
| [01-requirements.md](01-requirements.ko.md) | ingest runtime의 책임, 범위, acceptance 기준 |
| [02-architecture.md](02-architecture.ko.md) | facade, BrokerPoller, Kafka client, completion monitor 관계 |
| [03-design.md](03-design.ko.md) | config key, 입력/출력 계약, raw payload cache 규칙 |
