...
- **[secure-kafka-config.md](./secure-kafka-config.md)** - TLS/SASL Kafka client configuration and secret-handling guide
...
- For TLS/SASL Kafka client configuration and secret handling, use `secure-kafka-config.md`.
