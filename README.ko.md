...
- **릴리즈 라인 지원:** prerelease-only 단계에서는 최신 prerelease가 active support 대상입니다. `1.0.0` 이후에는 최신 stable minor를 active support로, 직전 stable minor를 security-fix-only로 운영합니다.
